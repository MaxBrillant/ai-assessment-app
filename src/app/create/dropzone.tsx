...
const DropZone = (props: { onFileUpload: (file: File) => void }) => {
  ...
  return (
    <button
      {...getRootProps()}
      className="w-full aspect-[4/2] flex flex-col p-10 items-center justify-center gap-2 bg-black/10 rounded-2xl border-[3px] border-opacity-70 border-dashed border-black"
      onClick={() => document.getElementById("doc")?.click()}
    >
      <FiUpload className="w-10 h-10 p-2 bg-white rounded-xl" />
